...
const zqwnurlArr = ['http://wn.xingguozuliao.com/login/login2/hydata.html'], zqwnhdArr = ['{"Accept":"*/*","Accept-Encoding":"gzip, deflate","Connection":"keep-alive","Content-Type":"application/x-www-form-urlencoded; charset=utf-8","Host":"wn.xingguozuliao.com","User-Agent":"0.0.19 rv:0.0.1 (iPhone; iOS 14.4.2; zh_CN)","Content-Length":"67","Accept-Language":"zh-cn"}'],zqwnbodyArr = ['oaid=100&uid=4671&yhtk=70E00F56-5A15-4775-8699-C916F5A801BE&apple=1'],zqwncount = ''
